...
<body>
    ...
    echo "<h4>Looping ASC</h4>";
    $angkaLoop1 = 2;
    while ($angkaLoop1 <= 20) {
        echo $angkaLoop1 . " - I Love PHP <br>";
        $angkaLoop1 += 2;
    };

    // echo "<h4>Coba</h4><br>";
    // for ($angkaLoop3 = 2; $angkaLoop3 <= 20; $angkaLoop3 += 2) {
    //     echo $angkaLoop3 . " - I Love PHP <br>";
    // };

    echo "<h4>Looping DSC</h4>";
    for ($angkaLoop2 = 20; $angkaLoop2 >= 1; $angkaLoop2 -= 2) {
        echo $angkaLoop2 . " - I Love PHP <br>";
    };
    ...
    // atau cara cepat
    echo "<br> Cara Cepat Array sisa baginya adalah:  ";
    echo "<br>";
